...
## CREAZIONE MANUALE DEL SEED
* [![CREDITS](https://img.shields.io/badge/CREDITS-blue.svg)](https://estudiobitcoin.com/como-calcular-tu-semilla-100-offline/)  [OP_1 Carta, penna & moneta](https://github.com/Cmod777/btc_vault#op_1)
* [![CREDITS](https://img.shields.io/badge/CREDITS-green.svg)](https://github.com/massmux/HowtoCalculateBip39Mnemonic)  [OP_2 Bip39 Calcolo Manuale](https://github.com/Cmod777/btc_vault#op_2)
* [![CREDITS](https://img.shields.io/badge/CREDITS-green.svg)](https://github.com/massmux/Papergen)  [OP_3 Papergen](https://github.com/Cmod777/btc_vault#op_3)
* [![CREDITS](https://img.shields.io/badge/CREDITS-green.svg)](https://github.com/massmux/bip39-diceware-entropy)  [OP_4 Bip39 Entropia da dadi](https://github.com/Cmod777/btc_vault#op_4)
* [![CREDITS](https://img.shields.io/badge/CREDITS-red.svg)](https://github.com/Cmod777/SeedPills)  [OP_5 Pills Entropy](https://github.com/Cmod777/btc_vault#op_5)
...
L'obiettivo è calcolare BIP39 mnemonico di 12 parole partendo da un'entropia. In questo caso supponiamo di avere già un'entropia di 128 bit che significa 16 byte, 32 caratteri esadecimali. Usiamo solo i comandi del terminale, niente di più. Possiamo utilizzare qualsiasi computer offline per questo calcolo.

#### Entropia a 128 bit

Iniziamo con un'entropia a 128 bit come segue:

```
656d338db7c217ad57b2516cdddd6d06
```

Controllo della lunghezza esadecimale
...
Conversione dei dati in binario e calcolo dell'HASH SHA256
...
Ora prendiamo i primi 4 bit (cioè 1 carattere esadecimale) dell'hash risultante. Questo è il *checksum*. Nel nostro caso è _b_ Dobbiamo quindi aggiungere questo checksum all'entropia iniziale fornita alla fine dei dati esadecimali. Quindi otteniamo
...
Ora cambiamo l'intero esadecimale in binario
...
Dobbiamo dividere l'output binario che abbiamo ottenuto sopra, in 12 segmenti di 11 bit ciascuno. Ognuno di loro è una parola. Ci aspettiamo infatti di raggiungere le 12 parole da verificare con un apposito dizionario. Quindi facciamo:
...
Stiamo ora notando che i segmenti non sono omogeneizzati. Dobbiamo omogeneizzarli. A tale scopo basta aggiungere all'inizio del binario un numero di zeri pari alle restanti cifre dell'ultimo segmento. In questo caso ci manca 1 cifra. Quindi aggiungiamo 1 zero all'inizio del binario sopra e rifacciamo il calcolo
...
#### Ottieni la sequenza delle parole

Ora abbiamo 12 segmenti perfetti di 11 bit. Ognuno è una parola bip39. Ora dobbiamo convertire ciascuno di essi
...
Controllo della tabella delle parole inglesi BIP39: https://github.com/bitcoin/bips/blob/master/bip-0039/english.txt . Si prega di notare che la tabella parte da 1 mentre noi partiamo da zero. Quindi dobbiamo prendere il prossimo sul tavolo. In questo caso abbiamo la parola _grace_ come puoi controllare tu stesso

Ora andiamo avanti con la seconda parola:
...
## Verifica il risultato rispetto allo strumento ian coleman

 Puoi usare lo strumento Ian Coleman (bip39) per verificare tutti i calcoli che abbiamo fatto a mano in questo momento. Come puoi vedere, l'intero mnemonico corrisponde a ciò che viene restituito dallo strumento bip39.

[strumento bip39 di ian coleman](https://iancoleman.io/bip39/)

![iancoleman-bip39](https://i.ibb.co/QDsC3Cr/bip39-check.png)

### OP_3 

Clicca sul tasto per procedere >>> [![GO](https://img.shields.io/badge/VAI_A_PAPERGEN-red.svg)](https://github.com/massmux/Papergen)

### OP_4
#### bip39 entropia dai dadi

#### OBIETTIVO

L'obiettivo è aggirare i sistemi casuali hardware e creare manualmente la sequenza di 12 parole, generando manualmente l'entropia necessaria con dadi e monete. Questo ci permette di ottenere una sequenza casuale di 12 parole completamente fuori da qualsiasi sistema informatico.

#### Genera un mnemonico valido bip39 usando 4 dadi e una moneta

Genera un mnemonico bip39 usando una moneta e 4 dadi standard a 6 facce. Genera ciascuna delle parole lanciando la moneta (t=croce/h=testa) e lanciando i dadi (1-6). Nel caso in cui la sequenza risultante sia maggiore di 4362, dovrai lanciare nuovamente i dadi.

#### procedura

- tira i dadi e ottieni le 4 cifre
- scrivere su un foglio le cifre leggendole da sinistra verso destra
- tira la moneta e scrivi Testa o Croce prima del numero dal punto sopra
- cerca nella tabella la parola corrispondente alla sequenza alfanumerica che hai appena creato
- scrivi su un foglio di carta questa parola (l'ordine è importante)
- ripeti i punti sopra 12 volte per ottenere 12 parole

 per la parola 12 (che è un checksum) procedere come segue

- considera un blocco di 16 parole sul tavolo
- prova in quel blocco di 16 parole (dove vive la dodicesima parola) ogni parola come dodicesima parola possibile. Puoi farlo usando lo strumento bip39 di ian coleman
- quando lo strumento bip39 dice che la sequenza è valida bip39, ce l'hai fatta e hai la sequenza corretta delle ultime 12 parole
- ora puoi importare quella sequenza su un portafoglio
> NB: tutto questo deve essere fatto in un sistema OFFLINE (senza connessione internet)
...
- l'elenco è stato confrontato con [l'elenco BIP39](https://github.com/bitcoin/bips/blob/master/bip-0039/english.txt)
- su questo elenco è stata eseguita una serie di 10 prove casuali per essere sicuri che la sequenza di 12 parole risultante fosse corretta per lo standard bip39 e che fosse stata importata correttamente utilizzando un portafoglio software.
